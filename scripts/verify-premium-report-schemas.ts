...
function schema_rejects_direct_command_variants_from_reviewer_blocker() {
  ...
  const phaseEightCommands = [
    ...
    '잔류와 복귀 시나리오를 기계적으로 선택해야 합니다.',
    '8월 말까지 비자 스폰서십 서류 확보에만 모든 행동력을 집중하되, 미확보 시 즉각 대안 시나리오로 전환하십시오.',
    '체류 연장 시도를 중단하고 안전한 귀국 시나리오로 전환하여 재검토하십시오.',
    '조건이 충족되지 않는다면 한국 복귀 및 국내 커리어 리포지셔닝을 위한 서류 작업을 시작하는 것이 가장 안전한 항로입니다.',
    '8월까지 계약이 체결되지 않는다면 미련 없이 한국 귀국 및 국내 커리어 복귀 절차를 밟기 시작하십시오.',
    '7일 이내에 서면 피드백이 도달하지 않을 시 한국 귀국 전환 절차를 보류 없이 개시하는 조건입니다.',
  ];
