...
const ORACLE_PERSONAS: Record<OracleCharacterId, OraclePersonaProfile> = {
  general_orion: {
    ...
    specialty: 'general',
    descriptionKo: '질문 전체의 흐름을 읽고, 지금 가장 크게 바꿀 한 수를 짚어주는 기본 정리 관점',
    descriptionEn: 'A main decision lens that reads the overall flow of your question and identifies the single move that will most shift your current trajectory.',
  ...
  compatibility_cassio: {
    ...
    descriptionKo: '두 사람의 감정 온도, 소통 리듬, 오래 가는 관계 구조를 읽는 관계 정리 관점',
    descriptionEn: 'A relationship decision lens that reads the emotional temperature, communication rhythms, and durable structures between two people.',
  ...
  reunion_nova: {
    ...
    specialty: 'reunion',
    descriptionKo: '끊어진 관계에 남은 신호와 다시 이어질 조건, 재회 후 달라져야 할 패턴을 읽는 관계 정리 관점',
    descriptionEn: 'A decision lens that reads the remaining signals in a broken relationship, the conditions for reconnection, and patterns that must change.',
    recommendedContexts: ['love', 'general'],
  ...
  wealth_midas: {
    ...
    specialty: 'wealth',
    descriptionKo: '돈의 흐름, 지출 습관, 손실 리스크를 냉정하게 감별하는 재무 정리 관점',
    descriptionEn: 'A financial decision lens that coldly discerns cash flows, spending habits, and loss risks.',
  ...
  career_lyra: {
    ...
    specialty: 'career',
    descriptionKo: '직업 방향, 역할 적합도, 전환 타이밍을 현실적으로 설계하는 커리어 정리 관점',
    descriptionEn: 'A career decision lens that realistically designs professional direction, role fit, and transition timing.',
  ...
  business_draco: {
    ...
    specialty: 'business',
    descriptionKo: '창업, 부업, 사업 확장, 파트너십 리스크를 구조적으로 읽는 비즈니스 정리 관점',
    descriptionEn: 'A business decision lens that structurally reads startup, side hustle, expansion, and partnership risks.',
