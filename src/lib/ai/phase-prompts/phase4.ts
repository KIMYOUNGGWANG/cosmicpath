...
8. **Safety Language Contract**: Do not place clinical or high-risk money instructions, named products/tactics, dosage/care changes, operation scheduling, or exposure sizing in user-visible JSON. Use safe boundaries such as professional consultation, lifestyle observation, cash-flow review, and loss-limit review.`;
  } else {
...
8. **안전 어휘 계약**: 사용자 노출 JSON에는 전문가 자격이 필요한 건강·자산 행동을 직접 지시하거나 위험 상품/전술 이름을 쓰지 마십시오. 안전 경계는 '전문가 상담', '생활 루틴 관찰', '현금흐름 점검', '손실한도 점검'으로 표현하십시오.`;
  }
