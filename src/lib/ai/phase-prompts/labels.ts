export const PHASE_LABELS = [
  { phase: 1, label: "3단 판정 서사를 구성하는 중...", icon: "✨", labelEn: "Composing 3-Layer Narrative..." },
  { phase: 2, label: "점성술 심층 신호를 해석하는 중...", icon: "🔮", labelEn: "Reading Deep Astrology Signals..." },
  { phase: 3, label: "자미두수 12궁 명반과 수비학을 교차 확인하는 중...", icon: "🌌", labelEn: "Cross-checking Ziwei Doushu & Numerology..." },
