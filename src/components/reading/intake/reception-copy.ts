...
export const START_RECEPTION_COPY = {
  ...
  en: {
    ...
    subtitle:
      'Use Saju structure, astrology timing, and multi-layer synthesis to settle one delayed decision. The first verdict is free, and birth date is required.',
    ...
    sideNote:
      'Name, birth time, city, gender, and partner details are precision inputs, not the product identity.',
    ...
    writingItems: [
      ...
      'Add partner details only when relationship calibration helps.',
    ],
  },
...
export const INTAKE_SECTION_COPY = {
  ko: {
    ...
    sequenceSummary: '선택 질문 / 생년월일 기준 / 5단 융합 분석',
    questionLabel: '01 선택 질문',
    questionEyebrow: '선택 중심 진입',
    birthLabel: '02 생년월일 기준',
    birthEyebrow: '필수 판정 기준',
    tarotLabel: '03 5단 융합 의사결정 연산',
    tarotSummary: '사주, 점성술, 자미두수, 수비학 데이터를 결합하여 즉시 첫 판정을 도출합니다.',
  },
  en: {
    sequenceLabel: 'Decision Note intake order',
    sequenceSummary: 'Decision Question / Required Birth Date / 5-Layer Synthesis',
    questionLabel: '01 Decision Question',
    questionEyebrow: 'Decision-first intake',
    birthLabel: '02 Required Birth Date',
    birthEyebrow: 'Required baseline',
    tarotLabel: '03 5-Layer Synthesis Engine',
    tarotSummary: 'Synthesize Saju, astrology, Ziwei, and numerology to open the first verdict.',
  },
} as const satisfies Record<ReceptionLanguage, {
