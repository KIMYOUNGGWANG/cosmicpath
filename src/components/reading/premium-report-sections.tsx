        ...
        {cards.map((card, idx) => (
          <div key={idx} className="flex flex-col items-center">
            <div
              ...
              className="group relative aspect-[2/3] w-full cursor-pointer overflow-hidden rounded-lg border border-white/10 transition-all hover:border-tarot-purple/50 hover:shadow-[0_0_15px_rgba(139,92,246,0.2)]"
            >
              {card.image ? (
                <img
                  src={card.image}
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-black/40 p-2 text-center transition-all group-hover:bg-black/20">
                <span
                  className={cn(
                    'notranslate text-[10px] font-bold text-white/90 md:text-sm',
