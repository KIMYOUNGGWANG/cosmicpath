...
const PANEL_COPY = {
  ...
  basic: {
    ko: {
      label: '리딩 준비 중',
      pendingTitle: '질문에 맞는 정리를 준비하는 중',
    ...
    en: {
      ...
      footerText: 'No birth location was provided, so we keep this screen honest and base the note on the time you entered plus cross-system evidence.',
    },
  },
};
