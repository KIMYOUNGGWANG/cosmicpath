...
- `Next Move Report` is historical/campaign-only unless an existing paid report surface uses report wording for the paid `Detailed 3-Layer Decision Report`.
